...
-- Both addresses have the same type of 'Residential'. Let's check the status of the package.
-- (i.e. Whether the letter has been sent or not.)

-- Check the package features that include a congratulatory letter sent from Anneke to Varsha.
